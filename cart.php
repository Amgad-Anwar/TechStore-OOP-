									...
									<div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
                                        ...
                                        <div class="cart_item_action cart_info_col">
											...
											<div class="cart_item_text">
                                                <a href="handlers/remove-cart.php?id=<?=$id?>">
			...
			<div class="row">
				<div class="col-lg-10 offset-lg-1">
					<div class="contact_form_container">
						...
						<form method="POST" action="handlers/add-order.php" id="order_form">
							<div class="contact_form_inputs d-flex flex-md-row flex-column justify-content-between align-items-between">
								<input type="text" name="name" id="contact_form_name" class="contact_form_name input_field" require placeholder="Your name">
								<input type="email" name="email" id="contact_form_email" class="contact_form_email input_field" placeholder="Your email">
								<input type="text" name="phone" id="contact_form_phone" class="contact_form_phone input_field" require placeholder="Your phone number">
							</div>
