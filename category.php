...
use TechStore\Classes\Models\Product; 
 ...
 $pr= new Product;
 $products=  $pr->selectWhere("cat_id=$id" , "id,name,img,price");
					...
					<div class="shop_content">
						...
						<div class="product_grid">
							...
							<div class="product_item">
								...
								<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="uploads/<?= $product['img'] ?>" alt=""></div>
								<div class="product_content">
									<div class="product_price" style="font-size:20px;">$<?= $product['price'] ?></div>
